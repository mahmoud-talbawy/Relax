...
import 'pagee3_model.dart';
export 'pagee3_model.dart';

class Pagee3Widget extends StatefulWidget {
  const Pagee3Widget({super.key});

  static String routeName = 'pagee3';
  static String routePath = '/pagee3';

  @override
  State<Pagee3Widget> createState() => _Pagee3WidgetState();
}

class _Pagee3WidgetState extends State<Pagee3Widget>
    with TickerProviderStateMixin {
  late Pagee3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pagee3Model());
