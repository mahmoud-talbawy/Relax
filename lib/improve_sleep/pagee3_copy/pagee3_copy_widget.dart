...
import 'pagee3_copy_model.dart';
export 'pagee3_copy_model.dart';

class Pagee3CopyWidget extends StatefulWidget {
  const Pagee3CopyWidget({super.key});

  static String routeName = 'pagee3Copy';
  static String routePath = '/pagee3Copy';

  @override
  State<Pagee3CopyWidget> createState() => _Pagee3CopyWidgetState();
}

class _Pagee3CopyWidgetState extends State<Pagee3CopyWidget>
    with TickerProviderStateMixin {
  late Pagee3CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pagee3CopyModel());
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed(Pagee4Widget.routeName);

                        await UserInfoTable().update(
                          data: {
                            'wake_up': supaSerialize<PostgresTime>(
                        ...
                        await UserInfoTable().update(
                          data: {
                            'bed_time': supaSerialize<PostgresTime>(
                                PostgresTime(_model.datePicked)),
                          },
                          matchingRows: (rows) => rows.eqOrNull(
                            'id',
