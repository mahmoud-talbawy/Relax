...
import 'create_dosage_model.dart';
export 'create_dosage_model.dart';

class CreateDosageWidget extends StatefulWidget {
  const CreateDosageWidget({
    super.key,
    required this.goalidparameter,
  });

  final int? goalidparameter;

  @override
  State<CreateDosageWidget> createState() => _CreateDosageWidgetState();
}

class _CreateDosageWidgetState extends State<CreateDosageWidget> {
  late CreateDosageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateDosageModel());
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Enter Your Dosage Name',
                    labelStyle:
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Enter Your Dosage Description',
              ...
              Align(
                ...
                child: Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(65.0, 50.0, 65.0, 0.0),
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await MediacationTasksTable().insert({
                        'title': _model.taskTitleTextController.text,
                        'description':
                            _model.taskDescriptionTextController.text,
                        'goal_id': widget.goalidparameter,
                        'user_id': currentUserUid,
                        'dose_time': supaSerialize<DateTime>(_model.datePicked),
                      });
