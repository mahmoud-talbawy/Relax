...
export 'profile_change_model.dart';
...
class _ProfileChangeWidgetState extends State<ProfileChangeWidget> {
  late ProfileChangeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileChangeModel());
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  ...
                  await UserInfoTable().update(
                    data: {
                      'first-name': _model.firstnameTextController.text,
                      'last-name': _model.lastNameTextController.text,
                    },
