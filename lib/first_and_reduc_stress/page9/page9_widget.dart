...
import 'page9_model.dart';
export 'page9_model.dart';

class Page9Widget extends StatefulWidget {
  const Page9Widget({super.key});

  static String routeName = 'page9';
...
class _Page9WidgetState extends State<Page9Widget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Page9Model());
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            30.0, 30.0, 30.0, 0.0),
                        child: Text(
                          'this will inform whether you receive guidence related to school.',
                          textAlign: TextAlign.center,
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    font: GoogleFonts.salsa(
