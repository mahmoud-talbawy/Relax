...
import 's_page8_model.dart';
export 's_page8_model.dart';

class SPage8Widget extends StatefulWidget {
  const SPage8Widget({super.key});

  static String routeName = 'S_page8';
  static String routePath = '/sPage8';

  @override
  State<SPage8Widget> createState() => _SPage8WidgetState();
}

class _SPage8WidgetState extends State<SPage8Widget>
    with TickerProviderStateMixin {
  late SPage8Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SPage8Model());
